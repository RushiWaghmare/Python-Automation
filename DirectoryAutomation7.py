...
#print the size of all files in loop
    ...
    if (exist ==True):
        ...
        for foldername, subfoldername,filename in os.walk(DirName):
            for name in filename:
                ...
                # os.path.getsize()== use for geting size of current file in loop
                print("File size is : ",os.path.getsize(os.path.join(foldername,filename)),"Bytes")
